...
: ${BINARY_NAME:="netlinkd"}
: ${PROJECT_NAME:="netlinkd"} # if project name does not match binary name
: ${USE_SUDO:="true"}
...
: ${REPO_NAME:="fsc-demo-wim/netlinkd"}
: ${REPO_URL:="https://github.com/$REPO_NAME"}
: ${PROJECT_URL:="https://github.com/$REPO_NAMEv"}
